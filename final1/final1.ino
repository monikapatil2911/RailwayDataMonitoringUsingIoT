...
String apiWritekey = "XXJ8C0IH768596RJ"; // replace with your THINGSPEAK WRITEAPI key here
const char* ssid = "Gulshan"; // your wifi SSID name
const char* password = "gulshan12" ;// wifi pasword
